...
class libnest2dConan(ConanFile):
    ...
    def _configure_cmake(self, visual_studio = False):
        ...
        if self.options.enable_arcus:
            self._cmake.definitions["Protobuf_PROTOC_EXECUTABLE"] = "/home/peer23peer/.conan/data/protobuf/3.17.1/_/_/package/35ddb80ffcbc5db4cfc93b090217fba016d5d246/bin/protoc"
